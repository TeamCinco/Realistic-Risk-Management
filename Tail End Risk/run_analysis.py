...
# Stock
STOCK_SYMBOL = "SI=F"           # Change to any stock (e.g., "AAPL", "NVDA", "MSFT")
...
#
CUSTOM_STOCK_PRICE = 114.037       # Example: 400.0 (CAT price before drop)
...
#
TARGET_PRICE_TO_CHECK = 78.531       # Example: 380.0
